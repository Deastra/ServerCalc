...
public class Calc implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
    	...
    	if (e.getSource() == beq) {
    		double real_im_1[] = Calc.parseComplexNumber(textFields[0].getText());   
    		double real_im_2[] = Calc.parseComplexNumber(textFields[2].getText());
            try{
    ...
    public String Equals(Calculate obj,double a,double b, double c, double d,String op) throws Exception{
